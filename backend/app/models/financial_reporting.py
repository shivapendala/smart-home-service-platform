...
class FinancialReportingRelationalComponent26(Base):
    __tablename__ = "financial_reporting_relational_components_26"
    ...
    def __repr__(self) -> str:
        return f"<FinancialReportingRelationalComponent26(id={self.id}, name='{self.component_name}')>"

class FinancialReportingRelationalComponent27(Base):
    __tablename__ = "financial_reporting_relational_components_27"
    ...
    def __repr__(self) -> str:
        return f"<FinancialReportingRelationalComponent27(id={self.id}, name='{self.component_name}')>"

class FinancialReportingRelationalComponent28(Base):
    __tablename__ = "financial_reporting_relational_components_28"
    ...
    def __repr__(self) -> str:
        return f"<FinancialReportingRelationalComponent28(id={self.id}, name='{self.component_name}')>"

class FinancialReportingRelationalComponent29(Base):
    __tablename__ = "financial_reporting_relational_components_29"
    ...
    def __repr__(self) -> str:
        return f"<FinancialReportingRelationalComponent29(id={self.id}, name='{self.component_name}')>"

class FinancialReportingRelationalComponent30(Base):
    __tablename__ = "financial_reporting_relational_components_30"
    ...
    def __repr__(self) -> str:
        return f"<FinancialReportingRelationalComponent30(id={self.id}, name='{self.component_name}')>"
