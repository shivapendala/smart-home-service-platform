...
# Mount API Routers under /api/v1 and direct aliases /api/auth, /api/services, /api/bookings, /api/technicians, /api/admin, /api/payments, /api/reviews, /api/complaints
